...
int main()
{
    ...
    Personnage p4("JH", 8, 8, 5, 5, 0.15, 0.05, 0.05, -10, 2, 1);
    chevalier_de_la_rosette p2("Jeannette", 15, 5, 10, 50, 0.15, 0.05, 0.0, 10, 1, 0);
    p1.fiche();
    p4.fiche();
    p2.fiche();
    cout << "JH armure = " << p4.getArmure() << endl;
    p1.attaque(&p4);
    cout << endl;
    cout << "Jeannette armure = " << p2.getArmure() << endl;
    p1.attaque(&p2);
    cout << endl <<"Pv de JH = " <<p4.getPv() << endl <<  endl;
